...
public class BDController {
	...
	public String clasificacionColor(int num) {
		String clasificacion="";

		if (num>=90 && num<=99) {
			clasificacion="DarkGreen";
		}else if (num>=80 && num<=89) {
			clasificacion="green";
		}else if (num>=70 && num<=79) {
			clasificacion="yellow";
		}else if (num>=50 && num<=69) {
			clasificacion="orange";
	...
	public String colorLetra(String nombre) {
		String color="";
		if (!nombre.equalsIgnoreCase("SIMPLE") &&!nombre.equalsIgnoreCase("null")){
			color="white";
		}
		return color;
	}
